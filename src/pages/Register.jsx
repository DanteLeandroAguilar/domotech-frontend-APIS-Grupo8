        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
              o{' '}
              <Link to="/login" className="font-semibold text-primary hover:text-primary/80 transition-colors underline decoration-2 underline-offset-2">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
            <div className="space-y-5">
              <div>
                <label htmlFor="username" className="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-200">
                  Nombre de usuario
                </label>
                <div className="relative">
